...
(function () {
  ...
  */
	...
	var button = $('#topic-article-button');
	var topicKey = button.attr('topicKey');
	var popup = $("#topic-article-modal");

	button.click(function () {
		popup.modal('show');
	});

	$('#topic-article-modal-button').click(function (e) {
		...
		if (!data.title) return $.notify("Veuillez entrer un titre", "error");
...
var _ForumTopicArticle = __webpack_require__(3);

var _ForumTopicArticle2 = _interopRequireDefault(_ForumTopicArticle);

var _ForumTopicRemove = __webpack_require__(4);

var _ForumTopicRemove2 = _interopRequireDefault(_ForumTopicRemove);

var _ForumTopicSelection = __webpack_require__(5);
